...
class StatsPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        # 时段效率热力图
        heatmap_section = self._create_section(_("时段效率分布"))
        ...
        # 类别分布（环形图）
        donut_section = self._create_section(_("类别分布"))
        ...
        # 周对比
        week_compare_section = self._create_section(_("本周 vs 上周"))
        ...
        # ===== 底部全宽区域 =====
        # 应用/网站使用
        self.app_section = self._create_section(_("应用 / 网站使用"))
